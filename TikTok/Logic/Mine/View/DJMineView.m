...
- (void)loadMineView {
    ...
    self.rootScrollView.contentSize = CGSizeMake(SCREEN_WIDTH, SCREEN_HEIGHT + BACKGROUND_TWO_Y - STATUS_NAVIGATION_BAR_HEIGHT - STATUS_NAVIGATION_BAR_HEIGHT - 30);
    ...
    [self.topView setFrame:CGRectMake(0, -STATUS_NAVIGATION_BAR_HEIGHT, SCREEN_WIDTH, TOPVIEW_HEIGHT + STATUS_NAVIGATION_BAR_HEIGHT)];
